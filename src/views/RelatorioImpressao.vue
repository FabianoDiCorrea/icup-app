...
<div class="d-flex align-items-center justify-content-between mb-1">
    ...
    <div class="text-center px-3 py-1 bg-light rounded-pill fw-bold fs-5"
...
<!-- TEXTO DOS PÊNALTIS (FORA DA LINHA) -->
<div
    v-if="
        jogo.golsA === jogo.golsB &&
        jogo.penaltisA != null &&
        jogo.penaltisB != null &&
        jogo.penaltisA !== jogo.penaltisB
    "
    class="text-center text-secondary mb-1"
...
>
    ...
    venceu nos pênaltis ({{ jogo.penaltisA }}–{{ jogo.penaltisB }})
</div>
