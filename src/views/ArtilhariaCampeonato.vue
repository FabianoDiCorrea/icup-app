<template>
  ...
  <div class="d-flex align-items-center gap-2">
    ...
    <!-- PREFIXO: Técnico + País (condicional) -->
    <span
  v-if="jogador.tecnico"
  class="tecnico-label small"
>
  {{ jogador.tecnico }}
</span>

<span
  v-if="campeonato.adicionarNacionalidade && jogador.pais"
  class="pais-label small"
>
  {{ jogador.pais.substring(0,3).toUpperCase() }}
</span>


    <!-- Escudo NO MEIO -->
    <img
      :src="jogador.escudoTime"
...
export default {
  ...
  if (this.campeonato?.adicionarNacionalidade && time.pais) {
...
.tecnico-artilharia {
  font-size: 0.69rem;     /* 👈 AQUI você controla o tamanho */
  font-weight: 600;
  color: #89f127;
  white-space: nowrap;
}
