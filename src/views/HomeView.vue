...
<p class="home-subtitle">
  Gerencie campeonatos, clubes e técnicos de forma simples e organizada.
</p>
  ...
  <div class="container mt-4 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 fade-in">
      <div>
        ...
        <p class="text-muted small mb-0"><br> Seu APP de Gerenciamento de Campeonatos</p>
      </div>
      <div class="text-end d-none d-md-block">
        <span class="d-block text-white fw-bold">{{ saudacao }}, Jogador.</span>
...
.home-logo {
  width: 100%;
  max-width: 220px; /* mobile primeiro */
}
